...
public class GENERADOR_NUEVO_ARCHIVO {

	private Logger logger =  LoggerFactory.getLogger(GENERADOR_NUEVO_ARCHIVO.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(GENERADOR_NUEVO_ARCHIVO.class, args);
